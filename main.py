#!/usr/bin/env python3
# ============================================
# 🚀 Yasha Group Bot v4.2 — Fully Fixed Edition
# ============================================
...
# ============================================
# ✨ Custom Emoji IDs (پرمیوم - اصلاح شده)
# ============================================
...
# ============================================
# 🧹 پاکسازی پیام‌های ۴۸ ساعت گذشته (اصلاح شده)
# ============================================
...
async def purge_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = await reply_premium(update, "🧹 در حال پاکسازی پیام‌های ۴۸ ساعت گذشته...", context)
...
def main():
    ...
    logger.info("✅ ربات یاشا v4.2 شروع به کار کرد!")
    app.run_polling()
